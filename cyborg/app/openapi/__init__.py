...
WHITELIST_API_PATH = ['/openapi/v1/oauth2/token']
...
@openapi_blueprint.errorhandler(429)
...
@openapi_blueprint.errorhandler(Exception)
...
openapi_blueprint.before_request(api_before_request)
openapi_blueprint.after_request(api_after_request)
