...
@api_v2_blueprint.errorhandler(429)
...
@api_v2_blueprint.errorhandler(Exception)
...
api_v2_blueprint.before_request(api_before_request)
api_v2_blueprint.after_request(api_after_request)
