...
def main_worker(gpu,world_size,cell_dict):
    ...
    if len(cell_dict['roi_x']) == 0 :
        ...
        threshold_map = utils.produce_roi_threshold_map(cell_dict['roi_x'],cell_dict['roi_y'],slide,cell_dict['thresh_scale'])
...
#    wsi_cell_probs = []
    ...
    if gpu == 0:
        ...
        result_to_npz(gathered_wsi_cell_center_coords,gathered_wsi_cell_labels,gathered_wsi_patch_xy,gathered_wsi_cell_probs,cell_dict['slice_path'] )
...
if __name__ == '__main__':
    ...
    cell_dict['cell_model'] = os.path.join('AI','Model',cell_model)
