...
class DnaAlgBase:
    ...
    def dna_test(self, slide):
        ...
        plot_dna(nuclei_dna_index, areas, save_dir=os.path.dirname(slide.filename), abnormal_high_thres=self.config.abnormal_high_thres, abnormal_low_thres=self.config.abnormal_low_thres)
